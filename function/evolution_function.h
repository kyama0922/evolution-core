...
#if defined(_LINUX)
        //charからWcharに変換する
        extern u32 CharToWChar(c16* dest, u32 dummy/*Linuxでは使用されません*/, const c8* src);
        //charからWcharに変換する
        extern u32 CharToWChar(c16* dest, u32 dummy/*Linuxでは使用されません*/, const c8* src, u32 src_len);
#else        
        //charからWcharに変換する
...
#if defined(_LINUX)
        //Wcharからcharに変換する
        extern u32 WcharToChar(c8* dest, u32 dummy/*Linuxでは使用されません*/, const c16* src);
        //Wcharからcharに変換する
        extern u32 WcharToChar(c8* dest, u32 dummy/*Linuxでは使用されません*/, const c16* src, u32 src_len);
#else
        //Wcharからcharに変換する
